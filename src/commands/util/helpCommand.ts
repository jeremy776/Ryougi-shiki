...
export default {
  ...
  const embed = new MessageEmbed()
      ...
      for (const mod of module) {
        ...
        .setFooter("Links", `[Support Server](https://discord.gg/uQch8Yyqvs) | [Invite ${client.user.username}](https://discordapp.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)`)
